                ...
                <div class="page-header">
                    ...
                    <div class="breadcrumb-line">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Add New Know More</li>
                        </ul>
                    </div>
                </div>
                <!-- /page header -->
                <div class="content col-md-10">
                    <form action="{{url('/knowmore_store')}}" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{csrf_token()}}">

                        <div class="form-group row">
                            <label class="col-lg-2 control-label text-semibold"><strong>Image file Upload:</strong></label>
                            <div class="col-lg-10">
                                <input type="file" name="morepic" class="file-input">
                                <span class="help-block">Know More Image file Upload</span>
                            </div>
                        </div>
