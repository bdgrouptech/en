        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                ...
                <div class="content col-md-10">
                    <form action="{{url('/courses_store')}}" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{csrf_token()}}">

                        <div class="form-group row">
                            <label class="col-lg-2 control-label text-semibold"><strong>Image file Upload:</strong></label>
                            <div class="col-lg-10">
                                <input type="file" name="coursespic" class="file-input">
                                <span class="help-block">Courses Image file Upload</span>
                            </div>
                        </div>
