        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                ...
                <div class="content col-md-10">
                    {!! Form::model($stuff,['url' => 'update_stuff/'.$stuff->id, 'class' =>'form-horizontal','files' => true]) !!}

                        <div class="form-group row">
                            <label for="name" class="col-sm-2 col-form-label"><strong>{!! Form::label('name','Name:') !!}</strong> </label>
                            <div class="col-sm-10">
                                {!! Form::text('name', null,
                        ...
                        <div class="form-group row">
                            <label for="facebook" class="col-sm-2 col-form-label"><strong>{!! Form::label('facebook','Facebook URL:') !!}</strong> </label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            <label for="twitter" class="col-sm-2 col-form-label"><strong>{!! Form::label('twitter','Twitter URL:') !!}</strong> </label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            <label for="linkedin"  class="col-sm-2 col-form-label"><strong>{!! Form::label('linkedin','Linkedin URL:') !!}</strong> </label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="col-lg-3 col-sm-6">
                                    <div class="thumbnail">
                                        <div class="thumb">
                                            <img src="{{asset('upload/'.$stuff->stuffpic)}}" alt="{{ $stuff->name }}">
                                            <div class="caption-overflow">
                                    <span>
                                        <a href="{{asset('upload/'.$stuff->stuffpic)}}" data-popup="lightbox" rel="gallery" class="btn border-white text-white btn-flat btn-icon btn-rounded"><i class="icon-plus3"></i></a>
                                    </span>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="form-group">
                            <label class="col-lg-2 control-label text-semibold">{!! Form::label('stuffpic','Stuff Image upload: ') !!}</label>
                            <div class="col-lg-10">
                                {!! Form::file('stuffpic', null,
                                      array('class'=>'file-input',
                               )) !!}
                                <span class="help-block">Stuff Image Upload Here</span>
                            </div>
                        </div>
