    ...
    <div class="content">
        ...
        <div class="panel panel-white">
            <div class="panel-heading">
                <h6 class="panel-title">Admin List</h6>
            </div>
                ...
                @foreach($alladmin as $item)
                    <tr>
                        ...
                        @if( Auth::user()->role == "Super Admin")
                                <a href="/admin/delete/<?php echo $item->id ?>/<?php echo str_replace(' ','-',$item->name) ?>/" onclick="return confirm('Are you sure you want to delete this Person ?');">
