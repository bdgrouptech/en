                    ...
                    <div class="panel panel-flat">
                        ...
                        <table class="table datatable-basic">
                            ...
                            <tr>
                                ...
                                <td><img src="{{ asset('upload/'.$item->addmissionpic) }}" alt="" width="50" height="50"></td>
                                    ...
                                    <ul class="icons-list">
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                <li><a href="{{ url('edit_admission/'.$item->id) }}"><i class="glyphicon glyphicon-edit"></i> Edit</a></li>
                                                <li><a href="{{ url('delete_admission/'.$item->id) }}"><i class="glyphicon glyphicon-remove"></i> Delete</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </td>
