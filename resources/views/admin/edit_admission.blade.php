        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                ...
                <div class="content col-md-10">
                    {!! Form::model($addmission,['url' => 'update_addmission/'.$addmission->id, 'class' =>'form-horizontal','files' => true]) !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="col-lg-3 col-sm-6">
                                    <div class="thumbnail">
                                        <div class="thumb">
                                            <img src="{{asset('upload/'.$addmission->addmissionpic)}}" alt="{{ $addmission->name }}">
                                            <div class="caption-overflow">
                                        <span>
                                            <a href="{{asset('upload/'.$addmission->addmissionpic)}}" data-popup="lightbox" rel="gallery" class="btn border-white text-white btn-flat btn-icon btn-rounded"><i class="icon-plus3"></i></a>
                                        </span>
                                            </div>
                                        </div>
                                    </div>
