                ...
                <div class="page-header">
                    ...
                    <div class="breadcrumb-line">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Add New Activities</li>
                        </ul>
                    </div>
                </div>
                <!-- /page header -->
                <div class="content col-md-10">
                    <form action="{{url('/activities_store')}}" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{csrf_token()}}">

                        <div class="form-group row">
                            <label class="col-lg-2 control-label text-semibold"><strong>Image file Upload:</strong></label>
                            <div class="col-lg-10">
                                <input type="file" name="activitiespic" class="file-input">
