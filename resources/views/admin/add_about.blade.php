                ...
                <div class="content col-md-10">
                    <form action="{{url('/about_store')}}" method="POST" enctype="multipart/form-data" >
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-sm-2 col-form-label"><strong>About Description:</strong> </label>
                            <div class="col-sm-10">
                                <textarea class="form-control" name="aboutDes" rows="5" id="aboutDes" placeholder="About Description Here.."></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-2 control-label text-semibold"><strong>Image File Upload:</strong></label>
                            <div class="col-lg-10">
                                <input type="file" name="aboutpic" class="file-input">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="description" rows="5" id="description" placeholder="Description Here.."></textarea>
                            </div>
                        </div>
