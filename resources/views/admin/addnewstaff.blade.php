        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                ...
                <div class="content col-md-10">
                    <form action="{{url('/staff_store')}}" method="POST" enctype="multipart/form-data" >
                        <input type="hidden" name="_token" value="{{csrf_token()}}">
                        <div class="form-group row">
                            <label for="name" class="col-sm-2 col-form-label"><strong>Name:</strong> </label>
                            <div class="col-sm-10">
                                <input type="text" name="name" class="form-control" id="title" placeholder="Name Here..">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="facebook" class="col-sm-2 col-form-label"><strong>Facebook URL:</strong> </label>
                            <div class="col-sm-10">
                                <input type="text" name="facebook" class="form-control" id="facebook" placeholder="Facebook URL..">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="twitter" class="col-sm-2 col-form-label"><strong>Twitter URL:</strong> </label>
                            <div class="col-sm-10">
                                <input type="text" name="twitter" class="form-control" id="twitter" placeholder="Twitter URL..">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="linkedin"  class="col-sm-2 col-form-label"><strong>Linkedin URL:</strong> </label>
                            <div class="col-sm-10">
                                <input type="text" name="linkedin" class="form-control" id="linkedin" placeholder="Linkedin URL..">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="file" class="file-input" name="stuffpic">
